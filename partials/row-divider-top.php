...
//if( have_rows('flex_content_rows') ):
	...
	$top_divider_section_bg_color = get_sub_field('flex_top_divider_section_bg_color');
		...
		if( $top_divider_section ) { ?>
			<div class="flex_content_row_divider_top style-<?php echo $top_divider_section; ?>" style="<?php if( $top_divider_section_position == 'on-top' ) { ?>z-index:99999;<?php } ?>"><!-- flex_content_row_divider -->
			<?php if ($top_divider_section == 'opacity-circle' ) { ?>
			...
			<?php } ?>			
			<?php if ($top_divider_section == 'mountains' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'right-tilt' || $top_divider_section == 'left-tilt' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'drops' ) { ?>
			...
			<?php if ($top_divider_section == 'big-clouds' ) { ?>
			...
			<?php if ($top_divider_section == 'pyramids' ) { ?>
			...
			<?php if ($top_divider_section == 'triangle' ) { ?>
			...
			<?php if ($top_divider_section == 'circle' ) { ?>
			...
			<?php if ($top_divider_section == 'right-opacity-tilt' || $top_divider_section == 'left-opacity-tilt' ) { ?>
			...
			<?php if ($top_divider_section == 'opacity-triangle' ) { ?>
			...
			<?php if ($top_divider_section == 'right-arc' || $top_divider_section == 'left-arc' ) { ?>
			<svg viewBox="0 0 1280 140" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0s573.08 140 1280 140V0z"/></svg>
			<?php } ?>
			<?php if ($top_divider_section == 'right-opacity-arc' || $top_divider_section == 'left-opacity-arc' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'opacity-clouds' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'arrow' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'waves' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'opacity-waves' ) { ?>
			...
			<?php } ?>
			<?php if ($top_divider_section == 'cross' ) { ?>
