...
//if( have_rows('flex_content_rows') ):
	...
	$masthead_bottom_divider_section_bg_color = get_field('masthead_bottom_divider_section_bg_color');
		if( $masthead_bottom_divider_section ) { ?>
			<div class="flex_content_row_divider_bottom style-<?php echo $masthead_bottom_divider_section; ?>" style="<?php if( $masthead_bottom_divider_section_position == 'on-top' ) { ?>z-index:99999;<?php } ?>"><!-- flex_content_row_divider -->
			<?php if ($masthead_bottom_divider_section == 'opacity-circle' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'mountains' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'right-tilt' || $masthead_bottom_divider_section == 'left-tilt' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'drops' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'big-clouds' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'pyramids' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'triangle' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'circle' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'right-opacity-tilt' || $masthead_bottom_divider_section == 'left-opacity-tilt' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'opacity-triangle' ) { ?>
			...
			<?php if ($masthead_bottom_divider_section == 'right-arc' || $masthead_bottom_divider_section == 'left-arc' ) { ?>
			<svg viewBox="0 0 1280 140" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0s573.08 140 1280 140V0z"/></svg>
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'right-opacity-arc' || $masthead_bottom_divider_section == 'left-opacity-arc' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'opacity-clouds' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'arrow' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'waves' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'opacity-waves' ) { ?>
			...
			<?php } ?>
			<?php if ($masthead_bottom_divider_section == 'cross' ) { ?>
