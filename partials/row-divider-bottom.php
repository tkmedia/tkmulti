...
//if( have_rows('flex_content_rows') ):
	...
	$bottom_divider_section_bg_color = get_sub_field('flex_bottom_divider_section_bg_color');
		if( $bottom_divider_section ) { ?>
			...
			<?php if ($bottom_divider_section == 'mountains' ) { ?>
			...
			<?php if ($bottom_divider_section == 'pyramids' ) { ?>
			...
			<?php if ($bottom_divider_section == 'triangle' ) { ?>
			...
			<?php if ($bottom_divider_section == 'circle' ) { ?>
			...
			<?php if ($bottom_divider_section == 'right-opacity-tilt' || $bottom_divider_section == 'left-opacity-tilt' ) { ?>
			...
			<?php if ($bottom_divider_section == 'opacity-triangle' ) { ?>
			...
			<?php if ($bottom_divider_section == 'right-arc' || $bottom_divider_section == 'left-arc' ) { ?>
			<svg viewBox="0 0 1280 140" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0s573.08 140 1280 140V0z"/></svg>
			<?php } ?>
			<?php if ($bottom_divider_section == 'right-opacity-arc' || $bottom_divider_section == 'left-opacity-arc' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider_section == 'opacity-clouds' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider_section == 'arrow' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider_section == 'waves' ) { ?>
			...
			<?php } ?>
			<?php if ($bottom_divider_section == 'cross' ) { ?>
