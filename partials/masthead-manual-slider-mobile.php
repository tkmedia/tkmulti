		...
		<div id="main-top-slider">
			<div class="top-slider-bg top-slider-bg-multiple">
			    ...
			    <div id="top-slider" class="swiper-container <?php echo($slider_effect); ?> swiper-scale-effect" style="direction: ltr;">
				    <?php if( have_rows('mobile_page_top_slider_manual') ): ?>
				    <div class="slides single-slider swiper-wrapper">

						<?php 
						while( have_rows('mobile_page_top_slider_manual') ): the_row(); 
						$slider_manual_bg = get_sub_field('mobile_slider_manual_bg');
						$slider_manual_image = get_sub_field('mobile_slider_manual_image');
						$slider_manual_video = get_sub_field('mobile_slider_manual_video');
						
						$slider_manual_content = get_sub_field('mobile_slider_manual_content');
						$slider_manual_content_position = get_sub_field('mobile_slider_manual_content_position');
						?>
						...
						$youtube_vid_title_url = get_sub_field('mobile_slider_manual_video', false, false);
